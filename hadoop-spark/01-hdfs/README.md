...
## Por Terminal:
        ...
        $ ssh -i ~/st161220211estud.pem hadoop@ec2.....compute-1.amazonaws.com
...
También están en Amazon S3:      s3://st1612public/datasets
...
* archivos en Amazon s3:
    ...
    user@master$ hadoop distcp s3://st1612public/datasets/airlines.csv /tmp/
